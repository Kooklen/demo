  ...
  <div class="operat-platform">
    <div class="common-bg op_form filter-group">
      <div class="op_form_line filter-group-item">
        ...
        ></IviewInput>
        <IviewInput v-model="form.contactName" :label="'联系人:'"           placeholder="请输入联系人"
        ></IviewInput>
        <IviewInput v-model="form.contactTel" :label="'联系人电话:'"   placeholder="请输入联系人电话"></IviewInput>
